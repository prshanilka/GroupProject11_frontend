...
<b-row>
    <b-colxx xl="8" lg="12" style="margin:auto ">
        ...
        <b-card class="mb-4" :title="$t('agent.form')" v-show="submit_ag">
            <b-form @submit.prevent="onValitadeFormSubmit" class="av-tooltip tooltip-label-right">
                <b-form-group :label="$t('agent.name')">
                    ...
                    <b-form-invalid-feedback v-else-if="!$v.agent.name.minLength || !$v.agent.name.maxLength">{{$t('form.v-name')}}</b-form-invalid-feedback>
                </b-form-group>
                ...
                <b-form-group :label="$t('form.nic')">
                    ...
                    <b-form-invalid-feedback v-else-if="!$v.agent.nic.minLength || !$v.agent.nic.maxLength">{{$t('form.v-nic')}}</b-form-invalid-feedback>
                </b-form-group>
                ...
                <b-form-group :label="$t('form.address')" class="error-l-100">
                    ...
                    <b-form-invalid-feedback v-else-if="!$v.agent.address.minLength || !$v.agent.address.maxLength">{{$t('form.v-address')}}</b-form-invalid-feedback>
                </b-form-group>
                ...
                <b-form-group :label="$t('form.number')">
                    ...
                    <b-form-invalid-feedback v-else-if="!$v.agent.phone.minLength || !$v.agent.phone.maxLength">{{$t('form.v-number')}}</b-form-invalid-feedback>
                </b-form-group>
                ...
                <b-form-group :label="$t('agent.relation')">
                    ...
                    <b-form-invalid-feedback v-if="!$v.agent.relationship_with_elder.required">{{$t('agent.e-relation')}}</b-form-invalid-feedback>
