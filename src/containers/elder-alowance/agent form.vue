			...
			<b-card class="mb-4" v-show="submit_ag">
				<b-form @submit.prevent="onValitadeFormSubmit" class="av-tooltip tooltip-label-right">
					<b-form-group label="Agent Name">
						...
						>Your name must be between 3 and 16 characters</b-form-invalid-feedback>
					</b-form-group>
					...
					<b-form-group label="Agent NIC No">
						...
						>Your Agent Nic must be only 10 characters</b-form-invalid-feedback>
					</b-form-group>
					...
					<b-form-group label="Agent Addres" class="error-l-100">
						...
						>Your Agent Address must be between 6 and 256 characters</b-form-invalid-feedback>
					</b-form-group>
					...
					<b-form-group label="Relationship with Agent">
						...
						>Please enter Relationship with Agent</b-form-invalid-feedback>
						<!-- <b-form-invalid-feedback
