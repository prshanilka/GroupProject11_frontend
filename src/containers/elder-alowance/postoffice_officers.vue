        ...
        <b-card class="mb-4" v-show="submit_ag">
          ...
          >
            ...
            <b-form-group :label="$t('officer.name')">
              ...
              />
              <b-form-invalid-feedback
                v-if="!$v.postoffice_officer.name.required"
                >{{ $t("form.e-name") }}</b-form-invalid-feedback
              >
            </b-form-group>
            ...
            <b-form-group :label="$t('user.username')">
              ...
              />
              <b-form-invalid-feedback
                v-if="!$v.postoffice_officer.uname.required"
                >{{ $t("user.e-uname") }}</b-form-invalid-feedback
              >
            </b-form-group>
            ...
            <b-form-group :label="$t('user.password')">
              ...
              />
              <b-form-invalid-feedback
                v-if="!$v.postoffice_officer.pword.required"
                >{{ $t("user.e-pass") }}</b-form-invalid-feedback
              >
              <b-form-invalid-feedback
            ...
            <b-form-group :label="$t('form.nic')">
              ...
              />
              <b-form-invalid-feedback
                v-if="!$v.postoffice_officer.nic.required"
                >{{ $t("form.e-nic") }}</b-form-invalid-feedback
              >
              <b-form-invalid-feedback
                v-if="!$v.postoffice_officer.nic.validnic"
                >{{ $t("form.e-valid") }}</b-form-invalid-feedback
              >
              <b-form-invalid-feedback
                v-else-if="
                  !$v.postoffice_officer.nic.minLength ||
                    !$v.postoffice_officer.nic.maxLength
                "
            ...
            <b-form-group :label="$t('form.number')">
              ...
              />
              <b-form-invalid-feedback
                v-if="!$v.postoffice_officer.phone.required"
                >{{ $t("form.e-number") }}</b-form-invalid-feedback
              >
              <b-form-invalid-feedback
                v-else-if="!$v.postoffice_officer.phone.validphone"
                >{{ $t("form.vaid-no") }}</b-form-invalid-feedback
              >
              <b-form-invalid-feedback
                v-else-if="
                  !$v.postoffice_officer.phone.minLength ||
                    !$v.postoffice_officer.phone.maxLength
                "
            ...
            <b-form-group :label="$t('form.email')" class="error-l-100">
              ...
              />
              <b-form-invalid-feedback
                v-if="!$v.postoffice_officer.email.required"
                >{{ $t("form.e-mail") }}</b-form-invalid-feedback
              >
              <b-form-invalid-feedback
                v-else-if="!$v.postoffice_officer.email.email"
            ...
            <b-form-group :label="$t('officer.type')">
              ...
              />
              <b-form-invalid-feedback
                v-if="!$v.postoffice_officer.type.required"
