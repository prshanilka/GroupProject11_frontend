        ...
        <b-card class="mb-4" v-show="submit_ag">
            <b-form @submit.prevent="onValitadeFormSubmit" class="av-tooltip tooltip-label-right">
                <b-form-group label="District">
                    <b-form-select v-model="$v.postoffice.district.$model" :options="district_option" :state="!$v.postoffice.district.$error"></b-form-select>
                    <b-form-invalid-feedback v-if="!$v.postoffice.district.required">Please enter District</b-form-invalid-feedback>
                </b-form-group>

                <b-form-group label="Divisional Secratary Office">
                    <b-form-select v-model="$v.postoffice.divisional_off.$model" :options="divisional_off_option" :state="!$v.postoffice.divisional_off.$error"></b-form-select>
                    <b-form-invalid-feedback v-if="!$v.postoffice.divisional_off.required">Please enter Divisional Secratary Office</b-form-invalid-feedback>
                </b-form-group>
