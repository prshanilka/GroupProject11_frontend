        ...
        <b-card class="mb-4">
            <b-form class="av-tooltip tooltip-label-right">
                ...
                <b-form-group label="Agent name(if appointing)" class="error-l-100">
                    <b-form-input type="text" v-model="$v.elder.agent_name.$model" :state="!$v.elder.agent_name.$error" />
                    <b-form-invalid-feedback v-if="!$v.elder.agent_name.minLength || !$v.elder.agent_name.maxLength">
                ...
                <b-form-group label="Agent Nic ">
                    <b-form-input type="text" v-model="$v.elder.agent_nic.$model" :state="!$v.elder.agent_nic.$error" />
                    <b-form-invalid-feedback v-if="!$v.elder.agent_nic.minLength || !$v.elder.agent_nic.maxLength">
                ...
                <b-form-group label="Agent phone no">
                    <b-form-input type="text" v-model="$v.elder.agent_phone_no.$model" :state="!$v.elder.agent_phone_no.$error" />
                    <b-form-invalid-feedback v-if="!$v.elder.agent_phone_no.minLength || !$v.elder.agent_phone_no.maxLength">
                        YourAgent phone no only 10
                        characters
                    </b-form-invalid-feedback>
                </b-form-group>
                <b-form-group label="Agent Address" class="error-l-125">
                    <b-form-input type="text" v-model="$v.elder.agent_address.$model" :state="!$v.elder.agent_address.$error" />
                    <b-form-invalid-feedback v-if="!$v.elder.agent_address.minLength || !$v.elder.agent_address.maxLength">
                        Your Agent Address be between 10 and 256
                        characters
                    </b-form-invalid-feedback>
                </b-form-group>
                <b-form-group label="Agent relationship with Elder" class="error-l-125">
                    <b-form-input type="text" v-model="$v.elder.agent_relationship_with_elder.$model" :state="!$v.elder.agent_relationship_with_elder.$error" />
                    <b-form-invalid-feedback v-if="!$v.elder.agent_relationship_with_elder.minLength || !$v.elder.agent_relationship_with_elder.maxLength">
