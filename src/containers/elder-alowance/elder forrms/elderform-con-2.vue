        ...
        <b-card class="mb-4">
            ...
            <b-form class="av-tooltip tooltip-label-right">
                <b-form-group :label="$t('elder.id')">
                    <b-form-input type="text" v-model="$v.elder.elder_id.$model" :state="!$v.elder.elder_id.$error" />
                ...
                <b-form-group label="Other Elder Nic">
                    <b-form-input type="text" v-model="$v.elder.other_elder_nic.$model" :state="!$v.elder.other_elder_nic.$error" />
                    <b-form-invalid-feedback v-if="!$v.elder.other_elder_nic.minLength || !$v.elder.other_elder_nic.maxLength">
