...
export default {
	...
	created() {
		...
		axios({
			...
			this.postoffice.district = result.data.data.district_id;
			this.postoffice.divisional_off = result.data.data.divisional_id;
			this.postoffice.post_office_id = result.data.data.post_office_id;
			this.postoffice.name = result.data.data.name;
			this.postoffice.address = result.data.data.address;
			this.postoffice.phone = result.data.data.phone_no;
			this.postoffice.bank_account_no = result.data.data.bank_account_no;
			this.postoffice.email = result.data.data.email;
			this.postoffice.num_of_officers = result.data.data.num_of_offices;
		});
	},
