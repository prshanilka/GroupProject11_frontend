...
export default {
	...
	axios
			...
			.then(res => {
				...
				this.elder.name=res.data.data.name;
				this.elder.address=res.data.data.address;
				this.elder.nic_no=res.data.data.nic_id;
				this.elder.email=res.data.data.email;
				this.elder.sex=res.data.data.sex;
				this.elder.phone_no =res.data.data.number;
				this.elder.district =res.data.data.district_id;
				this.elder.divisional_off =res.data.data.divisional_secratory_id;
				this.elder.grama_niladari_div =res.data.data.gramaniladari_division_id;
				this.elder.nearest_post_office =res.data.data.near_post_office_id;
				this.elder.birth_day =res.data.data.birth_day;
			})
			.catch(err => {
				console.log(err);
			});
