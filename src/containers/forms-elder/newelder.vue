                ...
                <div class="wizard-basic-step">
                    <b-form class="av-tooltip tooltip-label-right">
                        ...
                        <b-form-group :label="$t('forms.email')">
                            <b-form-input type="text" v-model="$v.formStep1.email.$model" :state="!$v.formStep1.email.$error" />
                            <b-form-invalid-feedback v-if="!$v.formStep1.email.required">Please enter your email address</b-form-invalid-feedback>
                            <b-form-invalid-feedback v-else-if="!$v.formStep1.email.email">Please enter a valid email address</b-form-invalid-feedback>
                        </b-form-group>
                        <b-form-group :label="$t('forms.password')">
                            <b-form-input type="password" v-model.trim="$v.formStep1.password.$model" :state="!$v.formStep1.password.$error" />
