...
export default {
	...
	methods: {
		...
		finishedBusiness() {
			...
			const verify = {
		 gramaniladari_id:null,
         divisional_officer_id:null,
         divisional_head_id:null,
         gramaniladari_comment:null,
         divisional_officers_comment:null,
         divisional_head_comment:null,
         validity_by_gramaniladari:null,
         validity_by_divisional_officer:null,
         validity_by_divisional_head:null,
         correction:null,
         elder_id:null,
			};
			...
			axios({
				method: "patch",
				url: "/elders/update-elder-registration",
				data: body
			})
				.then(res => {
