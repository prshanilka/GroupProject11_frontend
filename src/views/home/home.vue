							...
							<div class="col-12 col-xl-4 col-lg-5 col-md-6">
								<div class="home-text">
									...
									<b-row>
										...
										<router-link tag="a" to="/user/login" class="white">registers</router-link>.
									</b-row>
								</div>
							</div>
						</div>
						...
						<div class="container" id="apps">
							...
							<div class="row screenshots">
								<div class="col-12 text-center mb-4">
									<b-tabs nav-class="justify-content-center" content-class="card-body pt-0" :no-fade="true">
										<b-tab v-for="(app,index) in applications" :key="`app_${index}`" :title="app.title">
						...
						<div class="row footer-row">
							...
							<div class="col-12 text-center footer-content">
								<a @click="scrollTo('#home')" href="javascript:;">
									<img class="footer-logo" alt="footer logo" src="/assets/logos/swsw.png" />
								</a>
							</div>
						</div>
					</div>
